...
class RoutingUseCases(
    ...
    def _unit_data_received(
        ...
        *,
        ...
        # system: SUB_MAP below already delivers it here. Flooding every OpenBridge with
        # e.g. each ARS/LRRP answer of a D-APRS gateway to a local MOTOTRBO multiplies
        # traffic by the number of bridges, and remote masters that mis-file those frames
        # create a dynamic talkgroup named after the radio id.
        protocols = self._get_protocols() if self._get_protocols else {}
